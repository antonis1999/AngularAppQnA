...
- Create Angular project with ng: `ng new angularappqna.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularappqna.client.esproj`).
